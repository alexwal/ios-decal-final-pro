...
final class MasterViewController4: UIViewController {
    ...
    private lazy var activityViewController : ActivityViewController4 = {
        let storyboard = UIStoryboard(name: "Main", bundle: Bundle.main)
        var viewController = storyboard.instantiateViewController(withIdentifier: "ActivityViewController4") as! ActivityViewController4
        self.add(asChildViewController: viewController)
        return viewController
    }()
    
    private lazy var distanceViewController : DistanceViewController4 = {
        let storyboard = UIStoryboard(name: "Main", bundle: Bundle.main)
        var viewController = storyboard.instantiateViewController(withIdentifier: "DistanceViewController4") as! DistanceViewController4
        self.add(asChildViewController: viewController)
        return viewController
    }()
