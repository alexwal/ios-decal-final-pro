...
final class MasterViewController2: UIViewController {
    ...
    private lazy var activityViewController : ActivityViewController2 = {
        let storyboard = UIStoryboard(name: "Main", bundle: Bundle.main)
        var viewController = storyboard.instantiateViewController(withIdentifier: "ActivityViewController2") as! ActivityViewController2
        self.add(asChildViewController: viewController)
        return viewController
    }()
    
    private lazy var distanceViewController : DistanceViewController2 = {
        let storyboard = UIStoryboard(name: "Main", bundle: Bundle.main)
        var viewController = storyboard.instantiateViewController(withIdentifier: "DistanceViewController2") as! DistanceViewController2
        self.add(asChildViewController: viewController)
        return viewController
    }()
