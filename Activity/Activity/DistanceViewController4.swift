...
class DistanceViewController4: UIViewController, ChartViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        distanceView.leftAxis.axisMaxValue = 105.0
        ...
        let points = DataGenerator.data(key: "year/distances")
